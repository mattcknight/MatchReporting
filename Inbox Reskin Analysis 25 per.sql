...
SELECT @StartDate = '2014-06-16 13:00', @EndDate = '2014-07-02 12:00'


IF object_id('tempdb.dbo.#InboxReskinUsers_tmp') IS NOT NULL DROP TABLE #InboxReskinUsers_tmp;
SELECT 
	Cohort = CASE WHEN RIGHT(LEFT(u.TestingGUID, 7), 1) IN ('0','1','2','3') THEN 'Test' ELSE 'Control' END
	,u.UserID
	,u.SignupDt
